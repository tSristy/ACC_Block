...
//         item.redirect_url ? navigate(item.redirect_url) : setOpenModel(true)
...
//                     }}
//                 >
//                     {mediaList.map((item, index) => (<BlogCard key={index} props={item} onClick={(e) => handleModel(item)} />))}
//                 </Stack>
//             </Container>
